...
static const char selborder[]       = "#4c566a";
...
static const char *volinccmd[]        =     { "pactl","set-sink-volume","@DEFAULT_SINK@","+5%",NULL };
static const char *voldeccmd[]        =     { "pactl","set-sink-volume","@DEFAULT_SINK@","-5%",NULL };
...
static const char *screenshotcmd[]    =     { "scrot","SS_%Y%m%d%H%M%S_$wx$h.png","-q","100", "-e", "mv $f ~/Pictures/Screenshots/" ,NULL };
